    ...
    <form action="controller" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tenxe" name="tenxe"
                   value="<%= xe != null ? ((Xe) request.getAttribute("xe")).getTenxe() : "" %>"
                   required>
        </div>
        <div class="mb-3">
            <label for="giaxe" class="form-label">Giá xe</label>
            <input type="text" class="form-control" id="giaxe" name="giaxe"
                   value="<%=xe !=null ? ((Xe) request.getAttribute("xe")).getGiaxe() : ""%>"
                   required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <section>
                ...
                <select class="form-select" id="mahangxe" name="mahangxe">
                    ...
                    %>
                    <option value="<%=hangXe.getId()%>" <%= xe != null && xe.getMahangxe().getId() == hangXe.getId() ? "selected" : "" %>>
                        <%=hangXe.getTenhang()%>
                    </option>
                    <%
                            }
